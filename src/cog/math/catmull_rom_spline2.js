...
let _evalSegmentPosition2 = (spline, t, segment) => {
  let 
    i = segment + 1,
    t2 = t * t,
    t3 = t2 * t;
...
let _evalSegmentDerivative2 = (spline, t, segment) => {
  let 
    i = segment + 1,
    t2 = t * t;
...
let _evalSegmentTangent2 = (spline, t, eps, segment) => {
  if(t <= 0.0) {
...
class CatmullRomSpline2 {
  ...
  compile(resolution, closed) {
    ...
    for(i = 0; i < numSegments; ++i) {
      ov = nv = _evalSegmentPosition2(this, 0.0, i);
  ...
  position(t) {
    ...
    return _evalSegmentPosition2(this, nt, i);
  }
  ...
  tangent(t, epsilon) {
    ...
    // get the position at target interpolation factor for target segment
    return _evalSegmentTangent2(this, nt, epsilon, i);
  }
}


export default CatmullRomSpline2;
